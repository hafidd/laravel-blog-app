        ...
        <form method="post" action="/artikel/{{$artikel->id}}" enctype="multipart/form-data">
            ...
            <div class="">
                <div class="mb-1 flex justify-between">
                    ...
                    <div class="w-full">
                        <input class="w-full" name="judul" type="text" value="{{$artikel->judul}}">
                        @error('judul')
            ...
            <div class="">
                <div class="mb-1 flex justify-between">
                    ...
                    <div class="w-full">
                        <input class="w-full" name="tags" type="text" value="{{$artikel->tags}}">
                        @error('tags')
                        <p class="text-red-500 text-sm mt-1">{{$message}}</p>
                        @enderror
                    </div>
            ...
            <div class="">
                <div class="mb-1 flex justify-between">
                    <span class="w-28 text-slate-100"> </span>
                    <div class="w-full">
                        <img src="/storage/{{$artikel->gambar}}" alt="">
                    </div>
                </div>
            </div>
            <div class="">
            ...
            <div class="">
                <div class="mb-1 flex justify-between">
                    ...
                    <div class="w-full">
                        <textarea name="konten" rows="7" class="w-full p-1">{{$artikel->konten}}</textarea>
                        @error('konten')
                        <p class="text-red-500 text-sm mt-1">{{$message}}</p>
                        @enderror
                    </div>
